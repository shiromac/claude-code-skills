...
```bash
curl -fsSL https://raw.githubusercontent.com/<user>/claude-code-skills/main/install.sh | bash
```

### 手動インストール

```bash
git clone --depth 1 https://github.com/<user>/claude-code-skills.git /tmp/claude-code-skills
